	...
	<?php 
		$no=1;
		$query = mysqli_query($koneksi,"SELECT * FROM pengaduan INNER JOIN customer ON pengaduan.nik=customer.nik WHERE pengaduan.status='proses' ORDER BY pengaduan.id_pengaduan DESC");
